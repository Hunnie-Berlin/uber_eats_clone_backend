  ...
  async createDish(
    ...
    try {
      ...
      if (owner.id !== restaurant.ownerId) {
        return {
          ok: false,
          error: 'You can create dishes only in your own restaurant.',
        };
      }
  ...
  async editDish(
    ...
    try {
      ...
      if (owner.id !== dish.restaurant.ownerId) {
        return {
          ok: false,
          error: 'You can edit dish only in your own restaurant.',
        };
      }
      console.log({ ...editDishInput });
  ...
  async deleteDish(
    ...
    try {
      ...
      if (owner.id !== dish.restaurant.ownerId) {
        return {
          ok: false,
          error: 'You can delete dish only in your own restaurant.',
        };
      }
